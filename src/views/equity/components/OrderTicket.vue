...
const commonValid = computed(() => {
  ...
  return !!displaySymbolCode.value && shares.value > 0 && validQuantity && (orderType.value === 'market' || price.value > 0)
})
...
function preview(side) {
  ...
  if (!isCustomManualInstrument.value && shares.value > maximum) {
