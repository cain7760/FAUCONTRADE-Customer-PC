...
const displayedDealPrice = computed(() => activeOrder.value?.deal?.customerPrice || activeOrder.value?.deal?.counterpartyPrice || '--')
const displayedDealQuantity = computed(() => activeOrder.value?.deal?.customerQuantity || activeOrder.value?.deal?.counterpartyQuantity || '--')
